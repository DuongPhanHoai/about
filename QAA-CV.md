...
- **End‑to‑end governance** for high‑risk events and complex releases
- **Risk‑based, shift‑left, automation‑first** QA strategies with clear quality gates
- Experience with **microservices, integration/E2E, performance, and reliability**

### People Management & Coaching

- Built and led teams up to **20 QE**; coached **60+ QA engineers** across multiple projects
- **Career frameworks, growth paths, and leadership pipelines** for QA roles
- **High‑trust, collaborative environments** across dev, QA, product, and ops

### Process & Cross‑Country Collaboration

- Worked with distributed teams across **Vietnam, Singapore, China, Australia, and India**
...
- Used AI tools (**Cursor / Composer**) to drive the full SDLC from idea to working product — requirement clarification, technical design, **Python/Node/React** implementation, test planning, and deployment scripts
...
- Built and led a **20‑person Quality Engineering organization**, structured into embedded QA squads and an independent integration testing team
- Led **offshoring of QE operations** from Australia and India to Vietnam, establishing a sustainable regional hub with consistent delivery and quality
...
- Integrated **AI tools (Cursor, MCPs)** into the testing pipeline to generate test scenarios and scripts from Figma designs and technical docs, improving coverage and reducing manual effort
...
- Proactively identified and mitigated **delivery and quality risks** using historical data and deep understanding of project cultures
...
- Designed and delivered a two-component trading operations platform: **Python Client (MT5 integration)** + **React/Node Server (remote dashboard and control)** + **MQL5 helper script**
- Owned **end-to-end delivery** across architecture, requirements, implementation, deployment, and quality validation for a multi-process system spanning trading, API proxying, and UI control
- Built operational capabilities including **RBAC, SQLite persistence, deployment/restart scripts,** and **CI-ready Playwright test strategy** (API-heavy + UI smoke coverage)
